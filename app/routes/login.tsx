                ...
                >
                    ...
                    <div className="w-full text-center">
                        <button
                            ...
                            name="_action"
                            value={action}
                            className="mt-2 rounded-xl bg-yellow-300 px-3 py-2 text-blue-600 font-semibold transition duration-300 ease-in-out hover:bg-yellow-400 hover:translate-y-1"
                        >
