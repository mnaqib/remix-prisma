...
import Kudo from '~/components/kudos'
...
export default function KudoModal() {
    ...
    useEffect(() => setFormError(actionData?.error || ''), [actionData])
    ...
    const handleStyleChange = (
        ...
        setFormData((form) => ({
            ...form,
            style: { ...form.style, [field]: e.target.value },
        }))
    }
    ...
    const getOptions = (data: any) =>
        Object.keys(data).reduce((acc: any[], curr) => {
            acc.push({
                name:
                    curr.charAt(0).toUpperCase() + curr.slice(1).toUpperCase(),
                value: curr,
            })
            return acc
        }, [])
                    ...
                    <div className="flex-1 flex flex-col gap-y-4">
                        ...
                        <div className="flex flex-col items-center md:flex-row md:justify-start gap-x-4">
                            <SelectBox
                                ...
                                onChange={(e) =>
                                    handleStyleChange(e, 'background')
                                }
